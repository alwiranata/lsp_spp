...
<head>
    ...
    <title>Petugas - Aplikasi Pembayarn SPP</title>
    ...
    <div class="container mt-5">
                    ...
                    <ul class="navbar-nav">
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a class="dropdown-item" href="petugas.php?url=pembayaran">Pembayaran</a></li>
                                <li><a class="dropdown-item" href="petugas.php?url=logout">Logout</a></li>
                            </ul>
                        </li>
                    </ul>
                </div>
        ...
        <div class="card mt-2" style="border-radius: 10px; background-color:#e3f3fd">
            <div class="card-body">
                ...
                $file = @$_GET['url'];
                if (empty($file)) {
                    echo  " <h6 class='text-secondary'>Halaman Petugas</h6>";
                } else {
                    include $file . '.php';
                }
                ?>
